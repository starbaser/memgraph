...
auto TryReadIntLiteral(EGraph const &eg, egraph const &facade, planner::core::EClassId eclass_id)
  ...
  auto const &lit_info = impl_of(facade).graph.storage<symbol::Literal>().info;
...
/// start/end with implicit step=1; non-literal or non-int args fall back to
/// kDefaultRowEstimate.  Cypher range is inclusive on both ends.
